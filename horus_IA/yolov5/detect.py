...
# Debido a un problema con PosixPath, le agrego estas 3 lineas para solucionar el problema
# Que el path sea el de windows, para que el programa lo reconosca
import torch
